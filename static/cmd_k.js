...
(function() {
  ...
  const defaultItems = [
    ...
    { title: '3D CAD & SolidWorks Lightweight Modeler Studio', url: '/cad', category: 'CAD & 3D', icon: '🧊' },
    { title: 'Involute Spur Gear Generator (STL/OBJ Export)', url: '/cad', category: 'CAD & 3D', icon: '⚙️' },
    { title: 'ISO Hex Bolt & Fastener Modeler (M3-M30)', url: '/cad', category: 'CAD & 3D', icon: '🔩' },
    { title: 'Structural Beam Profile Generator (I-Beam, Channel, Tube)', url: '/cad', category: 'CAD & 3D', icon: '🏗️' },
    ...
    { title: 'Bolt Tightening Torque & Preload Force Estimator', url: '/calc', category: 'Mechanical Calc', icon: '🔩' },
    { title: 'ISO 286 Limits & Fits Tolerance Analyzer', url: '/calc', category: 'Mechanical Calc', icon: '📐' },
    { title: 'QR Code & Wi-Fi Studio', url: '/security', category: 'Security', icon: '📱' },
    { title: 'Cryptographic File Hasher & Checksum (SHA-256, MD5)', url: '/security', category: 'Security', icon: '🔐' },
    { title: 'Secure Password & Passphrase Generator', url: '/security', category: 'Security', icon: '🔑' },
    { title: 'Side-by-Side Visual Text & Code Diff', url: '/security', category: 'Security', icon: '🔀' },
    { title: 'JSON Formatter & Validator', url: '/dev', category: 'Developer', icon: '{ }' },
    { title: 'Engineering Unit Converter', url: '/dev', category: 'Developer', icon: '📏' },
    { title: 'Regex Matcher & Tester', url: '/dev', category: 'Developer', icon: '.*' },
    { title: 'Master Services Directory', url: '/tools', category: 'Directory', icon: '🌐' },
